        ...
        <div className="flex items-center gap-4">
          {!active && (
            <button
              ...
              className="bg-sidebar-foreground/5 border border-sidebar-border rounded-full px-4 py-1.5 flex items-center gap-2 text-[#C5A46D] shadow-sm hover:bg-sidebar-foreground/10 transition-colors"
            >
